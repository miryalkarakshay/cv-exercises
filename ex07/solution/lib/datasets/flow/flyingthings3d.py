...
class FlyingThings3DTrain(FlyingThings3D):
    ...
    def __init__(self, root=None, aug_fcts=None, to_torch=False, verbose=True):
        ...
        super().__init__(sample_confs=sample_confs, use_subset=use_subset, split=split, root=root,
    ...
    def _get_sample_confs(self):
        ...
        sample_conf = {
            'images': [DataConf('frames_cleanpass', 'right', 0), DataConf('frames_cleanpass', 'right', 1)],
